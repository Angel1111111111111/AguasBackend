...
public class UserService : IUserService
{
    ...
    public async Task<ResponseDto<LoginResponseDto>> LoginUserAsync(LoginDto dto)
    {
            ...
            var authClaims = new List<Claim>
        {
            ...
            var token = await GenerateJwtTokenAsync(authClaims, userEntity);
            ...
            return new ResponseDto<LoginResponseDto>
            {
                ...
                Data = new LoginResponseDto
                {
                    ...
                    Token = token,
                    TokenExpiration = new JwtSecurityTokenHandler().ReadJwtToken(token).ValidTo
                }
            };
        }
    ...
    private async Task<string> GenerateJwtTokenAsync(List<Claim> authClaims, UserEntity user)
    {
        var claims = new[]
        {
        ...
        var creds = new SigningCredentials(authSigninKey, SecurityAlgorithms.HmacSha256);
